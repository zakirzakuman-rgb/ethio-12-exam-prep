...
// SECTION ONE: VOCABULARY (Substitution)
    { cat: "English", q: "1. Despite having enough time, his habit of _______ prevented him from completing tasks efficiently.", options: ["hesitation", "negligence", "procrastination", "withdrawal"], a: "procrastination" },
    { cat: "English", q: "2. The manager's harsh tone was intended to _______ employees into obeying the rules without question.", options: ["persuade", "intimidate", "motivate", "manipulate"], a: "intimidate" },
    { cat: "English", q: "3. The government introduced strict regulations to control carbon _______ from industries.", options: ["leakage", "production", "emission", "expansion"], a: "emission" },
    { cat: "English", q: "4. People living in poverty are often more _______ to economic shocks and natural disasters.", options: ["exposed", "vulnerable", "fragile", "sensitive"], a: "vulnerable" },
    { cat: "English", q: "5. In many developing countries, agriculture remains the primary source of _______ for millions of people.", options: ["income", "livelihood", "survival", "occupation"], a: "livelihood" },
    { cat: "English", q: "6. The school still follows a _______ approach, focusing on memorization rather than critical thinking.", options: ["traditional", "conventional", "conservative", "outdated"], a: "traditional" },
    { cat: "English", q: "7. The student felt a sense of _______ when speaking in front of a large and unfamiliar audience.", options: ["anxiety", "intimidation", "fearfulness", "discomfort"], a: "anxiety" },
    { cat: "English", q: "8. The rapid spread of technology has transformed modern communication.", options: ["slightly delayed", "completely changed", "temporarily supported", "managed with preparation"], a: "completely changed" },
    { cat: "English", q: "9. Many students found the examination challenging but manageable with preparation.", options: ["extremely easy", "requiring effort and skill", "impossible to complete", "unrelated to learning"], a: "requiring effort and skill" },
    { cat: "English", q: "10. The teacher tried to emphasize the importance of critical thinking skills.", options: ["ignore intentionally", "explain briefly", "give special importance to", "question repeatedly"], a: "give special importance to" },
    { cat: "English", q: "11. Environmental pollution has a significant impact on human health.", options: ["minor and unimportant", "noticeable and important", "confusing and unclear", "temporary and short-lived"], a: "noticeable and important" },
    { cat: "English", q: "12. The scientist provided a comprehensive explanation of the experiment.", options: ["incomplete and vague", "detailed and thorough", "brief and unclear", "unrelated and complex"], a: "detailed and thorough" },
    { cat: "English", q: "13. The new policy was controversial, causing strong disagreement among citizens.", options: ["widely accepted", "causing debate and disagreement", "clearly understood", "completely ignored"], a: "causing debate and disagreement" },

    // SECTION TWO: ANALOGY & SENTENCE COMPREHENSION
    { cat: "English", q: "14. Whisper : Speak ::", options: ["Shout : Yell", "Silence : Noise", "Murmur : Talk", "Cry : Laugh"], a: "Murmur : Talk" },
    { cat: "English", q: "15. Insult : Anger ::", options: ["Praise : Pride", "Fear : Escape", "Joke : Laughter", "Injury : Pain"], a: "Praise : Pride" },
    { cat: "English", q: "16. The instructions were too vague for the participants to follow without additional clarification.", options: ["The instructions were not clear enough...", "The instructions were so vague that the participants could follow...", "The instructions were clear enough...", "The instructions were vague, but the participants followed..."], a: "The instructions were not clear enough..." },
    { cat: "English", q: "17. The proposal was rejected, not because it lacked merit, but because it required resources that were not available at the time.", options: ["The proposal was rejected due to a lack of available resources...", "The proposal lacked merit, so it was rejected.", "The proposal was accepted despite having no resource requirements.", "The proposal was rejected despite having many resources."], a: "The proposal was rejected due to a lack of available resources..." },

    // SECTION THREE: READING PASSAGE ONE (Education/Globalization)
    { cat: "English", q: "18. In paragraph 3, the word 'they' refers to:", options: ["classrooms", "students", "digital tools", "teachers"], a: "digital tools" },
    { cat: "English", q: "19. In paragraph 4, the word 'this' refers to:", options: ["learning different languages", "developing a global perspective", "neglecting traditions", "criticizing education"], a: "developing a global perspective" },
    { cat: "English", q: "20. Why might technology increase inequality in education?", options: ["Because it replaces teachers", "Because it is too difficult to use", "Because not all students have equal access to it", "Because it reduces students' motivation"], a: "Because not all students have equal access to it" },
    { cat: "English", q: "21. What can be inferred about globalization's effect on education?", options: ["It has no significant influence", "It only affects economic subjects", "It encourages broader cultural understanding", "It eliminates the need for local knowledge"], a: "It encourages broader cultural understanding" },
    { cat: "English", q: "22. According to the passage, modern education emphasizes:", options: ["memorization and repetition", "discipline and obedience", "analytical thinking and creativity", "competition only"], a: "analytical thinking and creativity" },
    { cat: "English", q: "23. What is one benefit of online learning mentioned in the text?", options: ["It reduces the need for exams", "It allows students to learn at their own pace", "It eliminates all educational costs", "It replaces traditional schools entirely"], a: "It allows students to learn at their own pace" },
    { cat: "English", q: "24. What is the main idea of the passage?", options: ["Education should return to traditional teaching methods", "The evolution and expanded role of education in modern society", "Technology has completely replaced teachers in classrooms", "Globalization has negatively affected all education systems"], a: "The evolution and expanded role of education in modern society" },
    { cat: "English", q: "25. The word 'dynamic' in paragraph 1 most nearly means:", options: ["unchanging", "simple and slow", "complex and active", "traditional"], a: "complex and active" },

    // SECTION FOUR: READING PASSAGE TWO (Environment)
    { cat: "English", q: "26. The word 'inclusive' in paragraph 3 most nearly means:", options: ["selective", "accessible to many people", "expensive", "limited"], a: "accessible to many people" },
    { cat: "English", q: "27. In paragraph 5, the word 'this' refers to:", options: ["participating in activities", "teaching students about sustainability", "understanding consequences", "protecting organizations"], a: "teaching students about sustainability" },
    { cat: "English", q: "28. What can be inferred about overfishing?", options: ["It improves marine ecosystems", "It may lead to a decrease in fish populations", "It has no effect on the environment", "It increases biodiversity"], a: "It may lead to a decrease in fish populations" },
    { cat: "English", q: "29. Why is environmental conservation described as urgent?", options: ["Because resources are unlimited", "Because human activities are rapidly damaging the environment", "Because governments ignore all environmental issues", "Because nature can easily recover"], a: "Because human activities are rapidly damaging the environment" },
    { cat: "English", q: "30. What can be inferred about climate change's impact on farmers?", options: ["It guarantees better crop production", "It creates stable weather conditions", "It makes farming more predictable", "It creates uncertainty in agricultural activities"], a: "It creates uncertainty in agricultural activities" },
    { cat: "English", q: "31. According to the passage, what is one effect of deforestation?", options: ["Increased wildlife habitats", "Improved soil quality", "Destruction of ecosystems", "Reduced population growth"], a: "Destruction of ecosystems" },
    { cat: "English", q: "32. Which of the following is mentioned as a government action?", options: ["Ignoring pollution", "Promoting renewable energy", "Increasing fossil fuel use", "Reducing education"], a: "Promoting renewable energy" },
    { cat: "English", q: "33. The word 'sustainable' in paragraph 1 most nearly means:", options: ["temporary", "able to continue over a long time", "harmful", "expensive"], a: "able to continue over a long time" },

    // LANGUAGE FOCUS (Grammar)
    { cat: "English", q: "34. It was _______ remarkable progress in such a short time that even the supervisors were surprised.", options: ["such a", "so", "so a", "such"], a: "such a" },
    { cat: "English", q: "35. Despite the heavy storm and poor visibility, the pilot _______ land the aircraft safely.", options: ["could", "might", "was able to", "can"], a: "was able to" },
    { cat: "English", q: "36. There is _______ hope of completing the project on time due to continuous delays.", options: ["few", "little", "a few", "a little"], a: "little" },
    { cat: "English", q: "37. The number of students who _______ absent from the examination is increasing every year.", options: ["is", "was", "are", "have"], a: "is" },
    { cat: "English", q: "38. A number of participants _______ expressed dissatisfaction with the new policy.", options: ["has", "have", "is", "was"], a: "have" },
    { cat: "English", q: "39. Identify the incorrect sentence:", options: ["Walking through the park, I saw beautiful birds.", "Walking through the park, the birds were beautiful.", "While walking through the park, I noticed the flowers.", "As I walked through the park, I saw birds."], a: "Walking through the park, the birds were beautiful." },
    { cat: "English", q: "40. Identify the incorrect sentence:", options: ["He enjoys reading, writing, and speaking.", "She likes swimming, to run, and cycling.", "They prefer hiking and camping.", "He enjoys dancing and singing."], a: "She likes swimming, to run, and cycling." },
    { cat: "English", q: "41. _______ by the committee, the proposal was finally implemented.", options: ["Approving", "Approve", "Approved", "Having approve"], a: "Approved" },
    { cat: "English", q: "42. While the bridge _______, traffic was redirected to alternative routes.", options: ["was being repaired", "repaired", "is repaired", "has been repaired"], a: "was being repaired" },
    { cat: "English", q: "43. His explanation was completely _______, as it failed to address the main issue.", options: ["relevant", "relevantly", "irrelevant", "relevance"], a: "irrelevant" },
    { cat: "English", q: "44. She has been working all night; she _______ exhausted now.", options: ["must be", "might be", "can't be", "should be"], a: "must be" },
    { cat: "English", q: "45. He didn't attend the meeting; he _______ been informed about it.", options: ["must have", "might have", "can't have", "should have"], a: "might have" },
    { cat: "English", q: "46. You _______ submit the report today; the deadline has been extended.", options: ["must not", "should not", "don't have to", "cannot"], a: "don't have to" },
    { cat: "English", q: "47. _______ the heavy rainfall, the event continued as planned.", options: ["Although", "Because", "In spite of", "However"], a: "In spite of" },
    { cat: "English", q: "48. The plan is cost-effective; _______, it may not be sustainable in the long term.", options: ["therefore", "because", "on the other hand", "moreover"], a: "on the other hand" },
    { cat: "English", q: "49. The company failed to meet its targets; _______, it suffered significant losses.", options: ["however", "although", "consequently", "meanwhile"], a: "consequently" },
    { cat: "English", q: "50. By next year, she _______ in this organization for over a decade.", options: ["will work", "will have been working", "will have worked", "is working"], a: "will have been working" },
    { cat: "English", q: "51. By the time the police arrived, the thief _______.", options: ["escapes", "has escaped", "had escaped", "escaped"], a: "had escaped" },
    { cat: "English", q: "52. She _______ the answer already, so there is no need to repeat the explanation.", options: ["knows", "is knowing", "has known", "knew"], a: "knows" },
    { cat: "English", q: "53. The train _______ at 6:00 a.m. tomorrow.", options: ["leaves", "leaving", "will leave", "left"], a: "leaves" },
    { cat: "English", q: "54. If he _______ rich, he would invest in education.", options: ["was", "is", "were", "had"], a: "were" },
    { cat: "English", q: "55. If she had studied harder, she _______ the exam.", options: ["passes", "would have passed", "could pass", "passed"], a: "would have passed" },
    { cat: "English", q: "56. He cannot afford _______ such an expensive car at the moment.", options: ["buying", "bought", "to buy", "buy"], a: "to buy" },
    { cat: "English", q: "57. I will never forget _______ her for the first time.", options: ["meet", "meeting", "to meet", "met"], a: "meeting" },
    { cat: "English", q: "58. She completed the task _______, despite the complexity of the assignment.", options: ["careful", "care", "carefully", "caring"], a: "carefully" },
    { cat: "English", q: "59. She _______ herself the responsibility of organizing the entire event.", options: ["took upon", "took over", "took up", "took off"], a: "took upon" },
    { cat: "English", q: "60. The book _______ I borrowed yesterday is very interesting.", options: ["who", "whose", "which", "whom"], a: "which" },
    { cat: "English", q: "61. Hardly _______ the announcement when the audience began to react strongly.", options: ["he finished", "he had finished", "had he finished", "did he finish"], a: "had he finished" },
    { cat: "English", q: "62. The bouquet of roses _______ on the table, brightening the room.", options: ["sit", "are sitting", "sits", "have sat"], a: "sits" },
    { cat: "English", q: "63. 'I wish you _______ your phones during class time; it is becoming a serious disruption.'", options: ["turned off", "had turned off", "would turn off", "turn off"], a: "would turn off" },
    { cat: "English", q: "64. If water boils, it _______ steam.", options: ["turned into", "turns into", "will turn into", "would turn into"], a: "turns into" },
    { cat: "English", q: "65. He spoke quietly _______ disturb the audience during the performance.", options: ["lest", "so that", "so as not to", "for"], a: "so as not to" },
    { cat: "English", q: "66. She _______ an effort to improve her grades.", options: ["did", "made", "had", "gave"], a: "made" },
    { cat: "English", q: "67. Hana: 'Let's meet after we have finished our work.' Hawa: What did Hana suggest?", options: ["Hana suggested to meet...", "Hana suggested meeting...", "Hana suggested that they meet...", "Hana suggested that meeting..."], a: "Hana suggested that they meet..." },

    // COMMUNICATIVE ACTIVITIES
    { cat: "English", q: "68. Moderator: Given the long-term impact of industrial pollution, Expert: In my view, stricter regulations are absolutely necessary.", options: ["Why did industries ignore environmental laws?", "What do you think should be done to address this issue?", "How long has this problem existed?", "Can you explain what pollution is?"], a: "What do you think should be done to address this issue?" },
    { cat: "English", q: "69. Student A: Do you believe online learning can replace traditional classroom education entirely? Student B: _______, I think it can complement it but not fully replace it.", options: ["At that moment", "In the meantime", "From my perspective", "By accident"], a: "From my perspective" },
    { cat: "English", q: "70. Sara: Social media has made communication much easier. Miki: _______, but it has also reduced face-to-face interaction.", options: ["I completely disagree", "That's obvious", "I agree to some extent", "I have no idea"], a: "I agree to some extent" },
    { cat: "English", q: "71. Teacher: Students perform better under strict supervision. Student: _______, as some students actually perform better with more independence.", options: ["That is absolutely true", "I couldn't agree more", "I'm afraid I don't quite agree", "That's exactly what I think"], a: "I'm afraid I don't quite agree" },
    { cat: "English", q: "72. Manager: We should finalize the proposal by next week. Employee: _______, may I add something regarding the timeline?", options: ["I strongly disagree", "That's obvious", "Sorry to interrupt", "Go ahead"], a: "Sorry to interrupt" },
    { cat: "English", q: "73. Lecturer: The results were statistically insignificant due to sampling errors. Student: _______, do you mean the sample size was too small?", options: ["Why did you say that", "What a surprising result", "Could you clarify what you mean", "That's completely wrong"], a: "Could you clarify what you mean" },
    { cat: "English", q: "74. Team Leader: We've heard several ideas already. Member: I think we should consider a more cost-effective approach.", options: ["Why didn't you attend earlier?", "Who made this mistake?", "Would you like to share your thoughts?", "When will you leave?"], a: "Would you like to share your thoughts?" },
    { cat: "English", q: "75. Colleague A: The meeting is scheduled for Thursday afternoon. Colleague B: _______, it has been moved to Friday morning.", options: ["That's perfectly correct", "Actually, that's not quite right", "I completely agree", "There's no change"], a: "Actually, that's not quite right" },
    { cat: "English", q: "76. Supervisor: The report has already been submitted, _______? Assistant: Yes, it was sent this morning.", options: ["didn't it", "wasn't it", "hasn't it", "doesn't it"], a: "hasn't it" },
    { cat: "English", q: "77. Student A: I don't find mathematics particularly interesting these days. Student B: _______, especially when the lessons are too theoretical.", options: ["So do I", "I do", "Neither do I", "I don't either"], a: "Neither do I" },
    { cat: "English", q: "78. Teacher: 'You must submit your assignments by Monday.' Later, the student reported to a friend:", options: ["The teacher says submit...", "The teacher told submit...", "The teacher asked if we submitted...", "The teacher said that we had to submit..."], a: "The teacher said that we had to submit..." },
    { cat: "English", q: "79. Researcher A: The data clearly supports the hypothesis. Researcher B: _______, the evidence is quite convincing.", options: ["I don't think so", "I couldn't agree more", "That's unlikely", "I'm not sure"], a: "I couldn't agree more" },
    { cat: "English", q: "80. Friend A: Do you think the new policy will be effective? Friend B: _______, as there are still many unresolved issues.", options: ["I strongly support it", "It is definitely effective", "There is no doubt", "I'm not entirely convinced"], a: "I'm not entirely convinced" },
    { cat: "English", q: "81. Employee A: The workload has become overwhelming recently. Employee B: _______, perhaps we should request additional staff.", options: ["On the contrary", "In that case", "As a result of that", "In spite of that"], a: "In that case" },
    { cat: "English", q: "82. Friend A: Why don't we organize a study group to prepare for the exams? Friend B: _______, that could really help us stay focused.", options: ["I completely disagree", "That's impossible", "That's a great idea", "I doubt it"], a: "That's a great idea" },
    { cat: "English", q: "83. Almaz: I'm feeling a bit under the weather today. Biruk: _______", options: ["I hope you feel better soon.", "Yes, the weather is beautiful.", "I don't like the rain either.", "You should stand in the sun."], a: "I hope you feel better soon." },
    { cat: "English", q: "84. Man: I must apologize for being late; the traffic was terrible. Woman: _______ I just arrived myself.", options: ["How dare you!", "What a pity!", "You should have called", "It doesn't matter"], a: "It doesn't matter" },

    // WRITING ITEMS (Spelling, Punctuation)
    { cat: "English", q: "85. Which one of the following is correctly spelt?", options: ["Resilent", "conducive", "subsistence", "recpient"], a: "conducive" },
    { cat: "English", q: "86. Which one of the following is wrongly spelt?", options: ["Anxiety", "vulnerable", "charity", "recpriocally"], a: "recpriocally" },
    { cat: "English", q: "87. Choose the sentence that is correctly punctuated and capitalized:", options: ["The Minister of Education stated that; reforms...", "The Minister of Education stated that reforms...", "The Minister of education stated that reforms...", "The Minister of Education stated that, reforms..."], a: "The Minister of Education stated that reforms..." },
    { cat: "English", q: "88. Choose the sentence that is correctly punctuated:", options: ["\"It's important,\" she said, \"to be honest; hardworking, and responsible.\"", "\"It's important\", she said \"to be honest, hardworking and responsible\".", "\"It's important,\" she said, \"to be honest, hardworking, and responsible.\"", "\"Its important,\" she said, \"to be honest, hardworking and responsible.\""], a: "\"It's important,\" she said, \"to be honest, hardworking, and responsible.\"" },
    { cat: "English", q: "89. Choose the correctly punctuated sentence using colon and comma properly:", options: ["The teacher gave three instructions: read carefully, answer all questions and submit on time.", "The teacher gave three instructions; read carefully...", "The teacher gave three instructions: read carefully, answer all questions, and submit on time.", "The teacher gave: three instructions read carefully..."], a: "The teacher gave three instructions: read carefully, answer all questions, and submit on time." },
